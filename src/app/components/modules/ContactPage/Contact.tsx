      ...
      <div className="container">
        ...
        <div className="contact__wrapper">
          <div className="block phone-block">
            <span className={`${manrope400.className} block__title`}>
              Phone
            </span>
            <a href="tel:410782058388" className="block__phone-number">
              +41 &#40;078&#41; 205 83 88
            </a>
          ...
          <div className="block address-block">
            ...
            <a
              ...
              className="block__email-link"
            >
              luxtra.travel@gmail.com
            </a>
          </div>
        </div>
        ...
        <article className="map">
          ...
          <Image
            width={56}
            height={108}
            src="/img/contact/icon-location.svg"
            alt="Icon location"
            className="map__icon-location"
          />
        </article>
      </div>
    </section>
